                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                gzip_vary on;
                                                                                                                                                                                                                                                                                    gzip_min_length 1024;
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        if [ ! -L "/etc/nginx/sites-enabled/lamquangdai.vn" ]; then
                                                                                                                                                                                                                                                                                            sudo ln -s /etc/nginx/sites-available/lamquangdai.vn /etc/nginx/sites-enabled/
                                                                                                                                                                                                                                                                                            fi
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                if ! sudo certbot certificates | grep -q "lamquangdai.vn"; then
                                                                                                                                                                                                                                                                                                    echo -e "${YELLOW}🔒 Thiết lập SSL certificate...${NC}"
                                                                                                                                                                                                                                                                                                        # Note: Replace with your actual email
                                                                                                                                                                                                                                                                                                            sudo certbot --nginx -d lamquangdai.vn -d www.lamquangdai.vn --non-interactive --agree-tos --email admin@lamquangdai.vn || echo -e "${YELLOW}⚠️ SSL setup failed. Please run manually: sudo certbot --nginx -d lamquangdai.vn -d www.lamquangdai.vn${NC}"
                                                                                                                                                                                                                                                                                                            else
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                echo -e "${GREEN}🌐 Ứng dụng đang chạy tại: https://lamquangdai.vn${NC}"
                                                                                                                                                                                                                                                                                                                echo -e "${GREEN}🔍 Health check: https://lamquangdai.vn/health${NC}"
                                                                                                                                                                                                                                                                                                                echo -e "${YELLOW}📋 Những việc cần làm tiếp theo:${NC}"
                                                                                                                                                                                                                                                                                                                echo -e "1. Cập nhật password database trong file /var/www/ims-server/.env"
                                                                                                                                                                                                                                                                                                                echo -e "2. Đảm bảo DNS domain lamquangdai.vn trỏ về IP: 14.225.218.37"
