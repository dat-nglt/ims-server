...
export default (sequelize, DataTypes) => {
  const User = sequelize.define(
    'User',
    {
      ...
      // ID vai trò (FK) - Bắt buộc cho người dùng active
      role_id: {
        type: DataTypes.INTEGER,
        allowNull: false, // Thêm allowNull: false để đảm bảo
        references: {
          model: 'roles',
          key: 'id',
        },
        comment: 'ID vai trò: admin, manager, sales, technician',
      },
      // Phòng ban
      department: {
        type: DataTypes.STRING(100),
