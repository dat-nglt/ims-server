 ...
 * - Users: assigned_user_id, assigned_to_technician_id, created_by_sales_id, created_by
 * - Projects: project_id
...
export async function up(queryInterface, Sequelize) {
    const works = [
        // Công việc 1: Lắp đặt máy lạnh - thi công trọn gói
        {
            ...
            description: "Lắp đặt hệ thống máy lạnh multi-split cho văn phòng 2 tầng tại ABC Company, bao gồm: 4 dàn lạnh trong nhà, 2 dàn nóng ngoài trời, đường ống đồng, dây điện cấp, và các phụ kiện kèm theo. Bảo hành 5 năm",
            category_id: null,
            project_id: 1,
            assigned_user_id: 1, // Quản lý giao công việc
            assigned_to_technician_id: 2, // Kỹ thuật viên 2 thực hiện
        ...
        // Công việc 2: Bảo trì định kỳ máy lạnh
        {
            ...
            description: "Bảo trì định kỳ 4 dàn lạnh multi-split tại XYZ Ltd. Bao gồm: vệ sinh bộ lọc, kiểm tra gas, kiểm tra dòng điện, làm sạch dàn nóng, bơm nước thoát nước, kiểm tra van kỳ và các linh kiện",
            category_id: null,
            project_id: 1,
            assigned_user_id: 1, // Quản lý giao công việc
            assigned_to_technician_id: 3, // Kỹ thuật viên 3 thực hiện
            created_by_sales_id: 1, // Nhân viên kinh doanh
            created_by: 1, // Người tạo công việc
            priority: "medium",
            status: "completed",
        ...
        // Công việc 3: Sửa chữa máy lạnh - hỏng dàn nóng
        {
            ...
            description: "Sửa chữa máy lạnh multi-split bị hỏng dàn nóng. Tiến hành: tháo dàn nóng, kiểm tra hệ thống, thay thế dàn nóng mới, nạp gas R410A, kiểm tra lại toàn hệ thống, vận hành thử 30 phút",
            category_id: null,
            project_id: 1,
            assigned_user_id: 1,
            ...
            location_lat: 10.8550,
            location_lng: 106.6750,
            estimated_hours: 6,
            actual_hours: 2.5,
        ...
        // Công việc 4: Lắp đặt máy lạnh ceiling cassette
        {
            ...
            description: "Lắp đặt máy lạnh âm trần cassette 3 chiều cho phòng họp lớn. Bao gồm: thi công, cắt trần, lắp máy, đấu điện, nạp gas, kiểm tra. Công suất 28000 BTU, tiêu chuẩn Y tế",
            category_id: null,
            project_id: 1,
            assigned_user_id: 1,
            ...
            location_lat: 21.0200,
            location_lng: 105.8600,
            estimated_hours: 5,
            actual_hours: null,
        ...
        // Công việc 5: Nạp gas máy lạnh (R410A)
        {
            ...
            description: "Nạp gas máy lạnh multi-split hết gas do rò rỉ. Kiểm tra áp suất, sửa chữa điểm rò rỉ, nạp gas R410A 6kg, kiểm tra lại áp suất, vận hành kiểm tra nhiệt độ lạnh, cấp hóa đơn bảo hành 6 tháng",
            category_id: null,
            project_id: 1,
            assigned_user_id: 1,
            assigned_to_technician_id: 2,
            ...
            location_lat: 10.8600,
            location_lng: 106.6500,
            estimated_hours: 2,
            actual_hours: 1.75,
        ...
        // Công việc 6: Vệ sinh máy lạnh định kỳ
        {
            ...
            description: "Vệ sinh đầy đủ máy lạnh 6 bộ cho căn hộ. Bao gồm: tháo bộ lọc vệ sinh sạch, làm sạch tường dàn lạnh, làm sạch dàn nóng, kiểm tra đồng hồ gas, kiểm tra dòng điện, bơm nước thoát, kiểm tra van kỳ",
            category_id: null,
            project_id: 1,
            assigned_user_id: 1,
            assigned_to_technician_id: 3,
        ...
        // Công việc 7: Lắp đặt máy lạnh tủ đứng
        {
            ...
            description: "Lắp đặt máy lạnh tủ đứng 2 chiều 18000 BTU cho phòng hợp nhỏ. Bao gồm: thi công, đấu điện 3 pha, nạp gas, kiểm tra, bảo hành 3 năm máy, 1 năm dịch vụ",
            category_id: null,
            project_id: 1,
            assigned_user_id: 1,
            assigned_to_technician_id: 2,
            ...
            location_lat: 10.8050,
            location_lng: 106.7590,
            estimated_hours: 4,
            actual_hours: null,
        ...
        // Công việc 8: Sửa chữa máy lạnh - dàn lạnh chảy nước
        {
            ...
            description: "Sửa chữa máy lạnh bị chảy nước từ dàn lạnh. Kiểm tra van kỳ, kiểm tra ống thoát nước, làm sạch ống thoát, thay thế ống thoát nước nếu bị tắc hoặc hỏng, kiểm tra lại, vận hành thử",
            category_id: null,
            project_id: 1,
            assigned_user_id: 1,
            assigned_to_technician_id: 3,
        ...
        // Công việc 9: Tối ưu hóa hệ thống máy lạnh
        {
            ...
            description: "Phân tích và tối ưu hóa hiệu suất hệ thống máy lạnh multi-split. Kiểm tra áp suất gas, kiểm tra dòng điện, đo nhiệt độ bên ngoài/trong, cải thiện lưu thông khí, kiểm tra tất cả van kỳ, tối ưu hóa công suất",
            category_id: null,
            project_id: 1,
            assigned_user_id: 1,
            assigned_to_technician_id: 2,
            ...
            location_lat: 10.8700,
            location_lng: 106.6300,
            estimated_hours: 6,
            actual_hours: 2.5,
        ...
        // Công việc 10: Tư vấn và lắp đặt máy lạnh cho nhà mới
        {
            ...
            description: "Tư vấn, thiết kế và lắp đặt hệ thống máy lạnh toàn bộ cho nhà mới 250m2. Bao gồm: tư vấn giải pháp, thiết kế lưu thông khí, cắt tường, lắp ống đồng, dây điện, nạp gas, kiểm tra chất lượng, cấp hóa đơn, bảo hành 5 năm",
            category_id: null,
            project_id: 1,
            assigned_user_id: 1,
            assigned_to_technician_id: 3,
            ...
            location_lat: 10.7300,
            location_lng: 106.7000,
            estimated_hours: 12,
            actual_hours: null,
